...
class _CreatePostState extends State<Test> {
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          _buildSectionTitle('Mock'),
          _buildSectionTitleSub('A mock test exam is a simulated version of actual'),

          _buildSection(data,'2'),
          SizedBox(height: 15.0),
